...
for region_i = 1:4
    ...
    for i = 1:length(case_names)
        ...
        if(exist(['all_data_P/ELM_' case_name '.mat'],'file'))
            continue;
        end
        ...
        for day_i = 1:length(days)
            ...
            SOILICE = squeeze(mean(SOILICE,3));
            SOILLIQ = squeeze(mean(SOILLIQ,3));
        ...
        %% save
        save(['all_data_P/soil_Spatial_ELM_' case_name '_' num2str(region_i) '.mat'],...
