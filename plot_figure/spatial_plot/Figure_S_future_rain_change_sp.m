...
for region_i = 1:4
    ...
    for delta_T = 0:5
        ...
        if(delta_T ==0)
            ...
            plot_global_map(region_i, lats, lons, RAINs*3600, 0, limits(region_i), 'Control', 1, 1,'');
            ...
            delta_change = (RAINs - RAIN_hist)*3600;
...
set(gcf, 'Color', 'w');
exportgraphics(gcf,'../../figure/Figure_S_rainfall_spatial_map.tif','Resolution',300);
close all
