...
for region_i = 1:4
    ...
    for delta_T = 0:5
        ...
        if(delta_T ==0)
            ...
            plot_global_map(region_i, lats, lons, QINFLs*3600, 0, limits(region_i), 'Control', 1, 1,'');
            ...
            plot_global_map(region_i,lats, lons, (QINFLs - QINFL_hist)*3600, -limit_changes(region_i), limit_changes(region_i), ['+' num2str(delta_T) 'K'], 1, 0,'');
...
set(gcf, 'Color', 'w');
exportgraphics(gcf,'../../figure_P/Figure_S_QINFL_spatial_map_r.pdf','Resolution',300);
close all
