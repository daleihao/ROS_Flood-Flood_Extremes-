...
limits = [500, 80, 500,500];
limit_changes = [200,40,300,200];

event_names = {'1996PN','1996MA','2017CA-Jan','2017CA-Feb'};
figure;
...
for region_i = 1:4
    ...
    for delta_T = 0:5
        ...
        if(delta_T ==0)
            ...
            plot_global_map(region_i, lats, lons, SNOWs*3600, 0, limits(region_i), 'Control', 1, 1,'');
            ...
            delta_change = (SNOWs - SNOW_hist)*3600;
            delta_change(delta_change==0) = -0.01;
...
set(gcf, 'Color', 'w');
exportgraphics(gcf,'../../figure/Figure_S_snowfall_spatial_map_P.tif','Resolution',300);
close all
