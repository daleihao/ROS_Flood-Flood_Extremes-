function variables = get_hourly_variable(region_i, variable_name)
...
%% plot
variables = nan(6,(filter_days(2)-filter_days(1)+1)*24);
for delta_T = 0:5
    ...
    variables(delta_T+1,:) = variable(start_day:end_day);
