function plot_subfigure_elevation_gradient(region_i, variableName,islegend,isylabel,xlabeltext,ylabeltext,indexlabel,ymin,ymax,xmin,xmax,event_name)
...
if islegend
legend([p1 p2 p3 p4 p5 p6],{'Control', '+1K', '+2K', '+3K', '+4K', '+5K'},'location','west')
end
xlabel(xlabeltext);
if isylabel
ylabel(ylabeltext);
...
text(xmin+(xmax-xmin)/50,YL(1) + (YL(2) - YL(1))*0.05, event_name,'fontsize',18,'FontWeight','bold');
