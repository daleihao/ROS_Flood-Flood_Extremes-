...
export NameTag=Optimal_future_${deltaT}K_P_spinup
...
export initPath=/compyfs/haod776/e3sm_scratch/ROS/ROS_simulations/ROS_2017_CA_FLOOD_spinup_20230814/run/
export initFile=ROS_2017_CA_FLOOD_spinup_20230814.elm.r.2016-01-01-00000.nc
# TOP
...
./xmlchange NTASKS=256,STOP_N=12,STOP_OPTION=nmonths,JOB_WALLCLOCK_TIME="02:00:00",RUN_STARTDATE="2016-01-01",REST_N=6,REST_OPTION=nmonths,RESUBMIT=0
./xmlchange DATM_MODE=CLMMOSARTTEST,DATM_CLMNCEP_YR_START='2016',DATM_CLMNCEP_YR_END='2017'
...
export initPath=/compyfs/haod776/e3sm_scratch/ROS/ROS_simulations/ROS_1996_PN_FLOOD_spinup_20230814/run/
export initFile=ROS_1996_PN_FLOOD_spinup_20230814.elm.r.1995-01-01-00000.nc
# TOP
export RES=ELM_USRDAT
export COMPSET=IELMBC
export COMPILER=intel
...
./xmlchange LND_DOMAIN_PATH=${domainPath}
./xmlchange ATM_DOMAIN_PATH=${domainPath}
./xmlchange NTASKS=256,STOP_N=12,STOP_OPTION=nmonths,JOB_WALLCLOCK_TIME="02:00:00",RUN_STARTDATE="1995-01-01",REST_N=6,REST_OPTION=nmonths,RESUBMIT=0
./xmlchange DATM_MODE=CLMMOSARTTEST,DATM_CLMNCEP_YR_START='1995',DATM_CLMNCEP_YR_END='1996'
...
export initPath=/compyfs/haod776/e3sm_scratch/ROS/ROS_simulations/ROS_1996_MA_FLOOD_spinup_20230814/run/
export initFile=ROS_1996_MA_FLOOD_spinup_20230814.elm.r.1995-01-01-00000.nc
# TOP
export RES=ELM_USRDAT
export COMPSET=IELMBC
export COMPILER=intel
